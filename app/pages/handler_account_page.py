...
from .handler import HandlerWithAuthentication
from typing import Dict
from utilities.validations import ValidationPassword
from database import user_db
from utilities.other import HashingData, records_log_user_password_change
...
class HandlerRequestChangePassword(HandlerWithAuthentication):
    ...
    def __change_password_in_db(self, user_id) -> bool:
        ...
        if not user_db.check_user_password(user_id, hashed_password):
			self._set_operation_error(error_type=UserErrors.FALSE_PASSWORD, type_error="user")
			return False
